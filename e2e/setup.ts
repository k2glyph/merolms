...
Before(async function (this: MeroeduWorld) {
...
After(async function (this: MeroeduWorld) {
...
async function createNewSite() {
  ...
  const adminEmail = `admin-${tenantName}@meroedu.io`
  //Create site
  await page.goto("https://login.dev.meroedu.io:3000/signup")
