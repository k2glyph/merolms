...
func newBodyContext(method string, params web.StringMap, body, contentType string) *web.Context {
	...
	req.Host = "demo.test.meroedu.io:3000"
...
func TestContextID(t *testing.T) {
	...
	ctx := newGetContext("http://demo.test.meroedu.io:3000", nil)
...
func TestBaseURL(t *testing.T) {
	...
	Expect(ctx.BaseURL()).Equals("http://demo.test.meroedu.io:3000")
}

func TestBaseURL_HTTPS(t *testing.T) {
	RegisterT(t)

	ctx := newGetContext("https://demo.test.meroedu.io:3000", nil)

	Expect(ctx.BaseURL()).Equals("https://demo.test.meroedu.io:3000")
}

func TestBaseURL_HTTPS_Proxy(t *testing.T) {
	RegisterT(t)

	ctx := newGetContext("http://demo.test.meroedu.io:3000", map[string]string{
...
func TestCurrentURL(t *testing.T) {
	...
	ctx := newGetContext("http://demo.test.meroedu.io:3000/resource?id=23", nil)

	Expect(ctx.Request.URL.String()).Equals("http://demo.test.meroedu.io:3000/resource?id=23")
}

func TestTenantURL(t *testing.T) {
	RegisterT(t)

	ctx := newGetContext("http://login.test.meroedu.io:3000", nil)
	tenant := &entity.Tenant{
		ID:        1,
		Subdomain: "theavengers",
	}
	Expect(web.TenantBaseURL(ctx, tenant)).Equals("http://theavengers.test.meroedu.io:3000")
}
...
func TestTenantURL_SingleHostMode(t *testing.T) {
	...
	Expect(web.TenantBaseURL(ctx, tenant)).Equals("http://demo.test.meroedu.io:3000")
}
...
func TestAssetsURL_SingleHostMode(t *testing.T) {
	...
	env.Config.CDN.Host = "meroeducdn.com"
	Expect(web.AssetsURL(ctx, "/assets/main.js")).Equals("http://meroeducdn.com/assets/main.js")
	Expect(web.AssetsURL(ctx, "/assets/main.css")).Equals("http://meroeducdn.com/assets/main.css")
}
...
func TestAssetsURL_MultiHostMode(t *testing.T) {
	...
	ctx := newGetContext("http://theavengers.test.meroedu.io:3000", nil)
	ctx.SetTenant(&entity.Tenant{
		ID:        1,
		Subdomain: "theavengers",
		CNAME:     "feedback.theavengers.com",
	...
	Expect(web.AssetsURL(ctx, "/assets/main.js")).Equals("http://theavengers.test.meroedu.io:3000/assets/main.js")
	Expect(web.AssetsURL(ctx, "/assets/main.css")).Equals("http://theavengers.test.meroedu.io:3000/assets/main.css")

	env.Config.CDN.Host = "meroeducdn.com"
	Expect(web.AssetsURL(ctx, "/assets/main.js")).Equals("http://theavengers.meroeducdn.com/assets/main.js")
	Expect(web.AssetsURL(ctx, "/assets/main.css")).Equals("http://theavengers.meroeducdn.com/assets/main.css")
}
...
func TestCanonicalURL_SameDomain(t *testing.T) {
	...
	ctx.SetCanonicalURL("")
	Expect(ctx.Value("Canonical-URL")).Equals(`http://theavengers.test.meroedu.io:3000`)

	ctx.SetCanonicalURL("/some-url")
	Expect(ctx.Value("Canonical-URL")).Equals(`http://theavengers.test.meroedu.io:3000/some-url`)

	ctx.SetCanonicalURL("/some-other-url")
	Expect(ctx.Value("Canonical-URL")).Equals(`http://theavengers.test.meroedu.io:3000/some-other-url`)

	ctx.SetCanonicalURL("page-b/abc.html")
	Expect(ctx.Value("Canonical-URL")).Equals(`http://theavengers.test.meroedu.io:3000/page-b/abc.html`)
}
...
func TestGetOAuthBaseURL(t *testing.T) {
	...
	env.Config.HostMode = "multi"
	Expect(web.OAuthBaseURL(ctx)).Equals("https://login.test.meroedu.io")
...
func TestGetOAuthBaseURL_WithPort(t *testing.T) {
	...
	ctx := newGetContext("http://demo.test.meroedu.io:3000/hello-world", nil)

	env.Config.HostMode = "multi"
	Expect(web.OAuthBaseURL(ctx)).Equals("http://login.test.meroedu.io:3000")

	env.Config.HostMode = "single"
	Expect(web.OAuthBaseURL(ctx)).Equals("http://demo.test.meroedu.io:3000")
}
