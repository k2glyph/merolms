...
// IsProduction returns true on Meroedu production environment
func IsProduction() bool {
	return Config.Environment == "production" || (!IsTest() && !IsDevelopment())
}

// IsTest returns true on Meroedu test environment
func IsTest() bool {
	return Config.Environment == "test"
}

// IsDevelopment returns true on Meroedu production environment
...
// Subdomain returns the Meroedu subdomain (if available) from given host
