...
func TestVerifySignInKeyHandler_UnknownKey(t *testing.T) {
	...
	code, _ := server.
		OnTenant(mock.DemoTenant).
		WithURL("http://demo.test.meroedu.io/signin/verify?k=unknown").
...
func TestVerifySignInKeyHandler_ExpiredKey(t *testing.T) {
	...
	code, _ := server.
		OnTenant(mock.DemoTenant).
		WithURL("http://demo.test.meroedu.io/signin/verify?k=" + key).
		Execute(handlers.VerifySignInKey(enum.EmailVerificationKindSignIn))
...
func TestVerifySignInKeyHandler_CorrectKey_ExistingUser(t *testing.T) {
	...
	Expect(response.Header().Get("Location")).Equals("http://demo.test.meroedu.io")
...
func TestVerifySignInKeyHandler_PrivateTenant_InviteRequest_ExistingUser(t *testing.T) {
	...
	code, response := server.
		OnTenant(mock.DemoTenant).
		WithURL("http://demo.test.meroedu.io/invite/verify?k=" + key).
...
func TestVerifySignUpKeyHandler_PendingTenant(t *testing.T) {
	...
	code, response := server.
		OnTenant(mock.DemoTenant).
		WithURL("http://demo.test.meroedu.io/signup/verify?k=" + key).
...
func TestCompleteSignInProfileHandler_UnknownKey(t *testing.T) {
	...
	code, _ := server.
		OnTenant(mock.DemoTenant).
		WithURL("http://demo.test.meroedu.io/signin/complete").
...
func TestCompleteSignInProfileHandler_CorrectKey(t *testing.T) {
	...
	ExpectHandler(&query.GetVerificationByKey{}).CalledOnce()
	ExpectHandler(&query.GetUserByEmail{}).CalledOnce()
	ExpectMeroeduAuthCookie(response, newUser)
}
...
func TestSignInPageHandler_AuthenticatedUser(t *testing.T) {
	...
	code, response := server.
		...
		WithURL("http://demo.test.meroedu.io/signin").
...
func ExpectMeroeduAuthCookie(response *httptest.ResponseRecorder, expected *entity.User) {
	...
	if expected == nil {
		...
		for _, c := range cookies {
			...
			if cookie.Name == web.CookieAuthName {
				...
				ExpectMeroeduToken(cookie.Value, expected)
...
func ExpectMeroeduToken(token string, expected *entity.User) {
	user, err := jwt.DecodeMeroeduClaims(token)
	Expect(err).IsNil()
