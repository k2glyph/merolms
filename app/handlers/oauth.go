...
// The user profile is then used to either get an existing user on Meroedu or creating a new one
// Once Meroedu user is retrieved/created, an authentication cookie is store in user's browser
