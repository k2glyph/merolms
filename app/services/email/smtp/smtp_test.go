...
import (
	...
	"github.com/k2glyph/meroedu/app/services/email/smtp"
)
...
func TestSend_Success(t *testing.T) {
	...
	bus.Publish(ctx, &cmd.SendMail{
		From: dto.Recipient{Name: "Meroedu Test"},
		To: []dto.Recipient{
			{
				Name:    "Jon Sow",
...
func TestBatch_Success(t *testing.T) {
	...
	Expect(string(requests[1].body)).ContainsSubstring("From: \"Meroedu Test\" <noreply@random.org>\r\nReply-To: noreply@random.org\r\nTo: \"Arya Stark\" <arya.start@got.com>\r\nSubject: Message to: Arya\r\nMIME-version: 1.0\r\nContent-Type: text/html; charset=\"UTF-8\"\r\nDate: ")
