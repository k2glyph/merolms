...
import (
	...
	"github.com/k2glyph/meroedu/app/services/email/mailgun"
	"github.com/k2glyph/meroedu/app/services/httpclient/httpclientmock"
...
func TestSend_Success(t *testing.T) {
	...
	Expect(values.Get("from")).Equals(`"Meroedu Test" <noreply@random.org>`)
