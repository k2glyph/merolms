...
import { Button, Moment, Money } from "@meroedu/components"
import { VStack } from "@meroedu/components/layout"
import { useMeroedu } from "@meroedu/hooks"
import { BillingStatus } from "@meroedu/models"
  ...
  return (
    <VStack>
      ...
      <p>
        Last payment was{" "}
        <strong>
          <Money amount={props.subscription.lastPayment.amount} currency={props.subscription.lastPayment.currency} locale={meroedu.currentLocale} />
        </strong>{" "}
        on{" "}
        <strong>
          <Moment locale={meroedu.currentLocale} format="date" date={props.subscription.lastPayment.date} />
        </strong>
        .
      </p>
      <p>
    ...
    <VStack>
      ...
      {isExpired ? (
        <p>
          ...
          <strong>
            <Moment locale={meroedu.currentLocale} format="date" date={props.subscriptionEndsAt} />
          </strong>
    ...
    <VStack>
      ...
      {isExpired ? (
        <p>
          ...
          <strong>
            <Moment locale={meroedu.currentLocale} format="date" date={props.trialEndsAt} />
          </strong>
  ...
  return (
    <VStack>
      ...
      <p className="text-muted">
        You can still help us fund the development of Meroedu by contribution to our{" "}
        <a rel="noopener" target="_blank" className="text-link" href="https://opencollective.com/meroedu">
          OpenCollective
        </a>
        .
      </p>
