...
import { Button, OAuthProviderLogo, Icon, Field, Toggle, Form } from "@meroedu/components"
import { OAuthConfig, OAuthProviderOption } from "@meroedu/models"
import { OAuthForm } from "../components/OAuthForm"
import { actions, notify, Meroedu, Failure } from "@meroedu/services"
import { AdminBasePage } from "../components/AdminBasePage"

import IconPlay from "@meroedu/assets/images/heroicons-play.svg"
...
export default class ManageAuthenticationPage extends AdminBasePage<ManageAuthenticationPageProps, ManageAuthenticationPageState> {
  ...
  constructor(props: ManageAuthenticationPageProps) {
    ...
    this.state = {
      isAdding: false,
      isEmailAuthAllowed: Meroedu.session.tenant.isEmailAuthAllowed,
  ...
  private startTest = async (provider: string) => {
    const redirect = `${Meroedu.settings.baseURL}/oauth/${provider}/echo`
      ...
      <VStack spacing={8}>
          ...
          <Form error={this.state.error}>
            <Field label="Allow Email Authentication">
              <Toggle
                ...
                disabled={!Meroedu.session.user.isAdministrator || !this.state.canDisableEmailAuth}
        ...
        <div>
          ...
          <p>
            ...
            <a rel="noopener" className="text-link" target="_blank" href="https://meroedu.io/docs/configuring-oauth/">
              OAuth Documentation
            </a>
            .
          </p>
