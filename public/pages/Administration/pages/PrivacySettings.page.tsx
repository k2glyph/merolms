...
import { Toggle, Form, Field } from "@meroedu/components"
import { actions, notify, Meroedu } from "@meroedu/services"
import { AdminBasePage } from "@meroedu/pages/Administration/components/AdminBasePage"
...
export default class PrivacySettingsPage extends AdminBasePage<any, PrivacySettingsPageState> {
  ...
  constructor(props: any) {
    ...
    this.state = {
      isPrivate: Meroedu.session.tenant.isPrivate,
    }
  }
    ...
    return (
      <Form>
        <Field label="Private Site">
          <Toggle disabled={!Meroedu.session.user.isAdministrator} active={this.state.isPrivate} onToggle={this.toggle} />
