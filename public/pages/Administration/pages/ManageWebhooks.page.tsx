...
import { Webhook, WebhookData, WebhookStatus, WebhookType } from "@meroedu/models"
...
const ManageWebhooksPage = (props: ManageWebhooksPageProps) => {
  ...
  return render(
    <VStack spacing={8}>
      <p>
        Use webhooks to integrate Meroedu with other applications like Slack, Discord, Zapier and many others.{" "}
        <a className="text-link" href="https://meroedu.io/docs/using-webhooks" target="_blank" rel="noopener">
