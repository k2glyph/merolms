...
import { Modal, Button, DisplayError, Select, Form, TextArea, Field, SelectOption, Icon } from "@meroedu/components"
import { Post, PostStatus } from "@meroedu/models"

import { actions, Failure, Meroedu } from "@meroedu/services"
import { PostSearch } from "./PostSearch"
import IconSpeakerPhone from "@meroedu/assets/images/heroicons-speakerphone.svg"
...
export class ResponseForm extends React.Component<ResponseFormProps, ResponseFormState> {
  ...
  public render() {
    const button = (
      <Button className="w-full" onClick={this.showModal} disabled={Meroedu.isReadOnly}>
