...
import { Comment, Post, Tag, Vote, ImageUpload, CurrentUser } from "@meroedu/models"
import { actions, Failure, Meroedu, timeAgo } from "@meroedu/services"
        ...
        <div id="p-show-post" className="page container">
          <VStack className="p-show-post" spacing={4}>
                  ...
                  <div className="flex-grow">
                    ...
                    <span className="text-muted">
                      <Trans id="showpost.label.author">
                        Posted by <UserName user={this.props.post.user} /> &middot; <Moment locale={Meroedu.currentLocale} date={this.props.post.createdAt} />
                      </Trans>
                    </span>
                  </div>
                </HStack>
            ...
            <VStack spacing={4} className="p-show-post__action-col">
              ...
              {Meroedu.session.isAuthenticated && canEditPost(Meroedu.session.user, this.props.post) && (
                <VStack>
                  ...
                  {this.state.editMode ? (
                    <VStack>
                      <Button variant="primary" onClick={this.saveChanges} disabled={Meroedu.isReadOnly}>
                        <Icon sprite={IconCheck} />{" "}
                        <span>
                          <Trans id="action.save">Save</Trans>
                        </span>
                      </Button>
                      <Button onClick={this.cancelEdit} disabled={Meroedu.isReadOnly}>
                        <Icon sprite={IconX} />
                        <span>
                    ...
                    <VStack>
                      <Button onClick={this.startEdit} disabled={Meroedu.isReadOnly}>
                        <Icon sprite={IconPencilAlt} />
                        <span>
                          <Trans id="action.edit">Edit</Trans>
                        </span>
                      </Button>
                      {Meroedu.session.user.isCollaborator && <ResponseForm post={this.props.post} />}
                    </VStack>
                  )}
                </VStack>
              )}
              ...
              <PoweredByMeroedu slot="show-post" />
            </VStack>
