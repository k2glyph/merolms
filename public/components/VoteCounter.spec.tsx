...
import { Post, UserRole, PostStatus, UserStatus } from "@meroedu/models"
import { VoteCounter } from "@meroedu/components"
import { screen, fireEvent, render } from "@testing-library/react"
import { meroeduMock, httpMock, setupModalRoot } from "@meroedu/services/testing"
...
describe("<VoteCounter />", () => {
  test("when hasVoted === true", () => {
    ...
    const { container } = render(
      <MeroeduContext.Provider value={meroeduMock.authenticated()}>
