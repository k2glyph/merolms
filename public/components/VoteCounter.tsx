...
import { actions, classSet } from "@meroedu/services"
import { Icon, SignInModal } from "@meroedu/components"
import { useMeroedu } from "@meroedu/hooks"
import FaCaretUp from "@meroedu/assets/images/fa-caretup.svg"
...
export const VoteCounter = (props: VoteCounterProps) => {
  ...
  const isDisabled = status.closed || meroedu.isReadOnly
